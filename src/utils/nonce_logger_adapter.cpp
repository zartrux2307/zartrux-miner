...
PYBIND11_MODULE(nonce_adapter, m) {
    py::class_<NonceLoggerAdapter>(m, "NonceLoggerAdapter")
        ...
        .def("log_python_event", &NonceLoggerAdapter::logPythonEvent,
             py::arg("level"), py::arg("message"), py::arg("extra") = py::dict())
        .def("log_export_progress", &NonceLoggerAdapter::logExportProgress,
             py::arg("processed"), py::arg("total"), py::arg("additional_info") = "")
        .def("log_file_operation", &NonceLoggerAdapter::logFileOperation,
